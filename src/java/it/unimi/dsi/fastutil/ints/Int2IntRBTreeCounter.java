 ...
 *
 */
public class Int2IntRBTreeCounter extends AbstractInt2IntSortedMap implements java.io.Serializable, Cloneable {
    ...
    protected transient volatile ObjectSortedSet<Int2IntMap.Entry > entries;
    /** Cached set of keys. */
  ...
  /* If the provided comparator is already type-specific, we use it. Otherwise,
     ...
     */
    public Int2IntRBTreeCounter( final Comparator<? super Integer> c ) {
        this();
        storedComparator = c;
        setActualComparator();
    }
     ...
     */
    public Int2IntRBTreeCounter( final Map<? extends Integer, ? extends Integer> m ) {
        this();
        putAll( m );
    }
     ...
     */
    public Int2IntRBTreeCounter( final SortedMap<Integer,Integer> m ) {
        this( m.comparator() );
        putAll( m );
    }
    /** Creates a new tree map copying a given map.
     ...
     */
    public Int2IntRBTreeCounter( final Int2IntMap m ) {
        this();
        putAll( m );
    }
    /** Creates a new tree map copying a given sorted map (and its {@link Comparator}).
     ...
     */
    public Int2IntRBTreeCounter( final Int2IntSortedMap m ) {
        this( m.comparator() );
        putAll( m );
    }
     ...
     */
    public Int2IntRBTreeCounter( final int[] k, final int v[], final Comparator<? super Integer> c ) {
        this( c );
     ...
     * @throws IllegalArgumentException if <code>k</code> and <code>v</code> have different lengths.
     */
    public Int2IntRBTreeCounter( final int[] k, final int v[] ) {
        this( k, v, null );
    }
 /*
    ...
    public int increment( final int k, final int v ) {
        modified = false;
        int maxDepth = 0;
        if ( tree == null ) { // The case of the empty tree is treated separately.
            count++;
    ...
    public Integer put( final Integer ok, final Integer ov ) {
        final int oldValue = put( ((ok).intValue()), ((ov).intValue()) );
        return modified ? (null) : (Integer.valueOf(oldValue));
    }
    public Integer remove( final Object ok ) {
        final int oldValue = remove( ((((Integer)(ok)).intValue())) );
     ...
     */
    private static final class Entry implements Cloneable, Int2IntMap.Entry {
        ...
        public boolean equals( final Object o ) {
            ...
            return ( (key) == (((e.getKey()).intValue())) ) && ( (value) == (((e.getValue()).intValue())) );
        }
        public int hashCode() {
            return (key) ^ (value);
        }
  ...
  /*
   ...
   /* If the last operation was a next(), we are removing an entry that preceeds
            ...
            updatePrevious();
            updateNext();
            Int2IntRBTreeCounter.this.remove( curr.key );
            curr = null;
        }
     ...
     * <P>This class can iterate in both directions on a threaded tree.
     */
    private class EntryIterator extends TreeIterator implements ObjectListIterator<Int2IntMap.Entry > {
        EntryIterator() {}
        EntryIterator( final int k ) {
            super( k );
        }
        public Int2IntMap.Entry next() { return nextEntry(); }
        public Int2IntMap.Entry previous() { return previousEntry(); }
        public void set( Int2IntMap.Entry ok ) { throw new UnsupportedOperationException(); }
        public void add( Int2IntMap.Entry ok ) { throw new UnsupportedOperationException(); }
    }
    public ObjectSortedSet<Int2IntMap.Entry > int2IntEntrySet() {
        if ( entries == null ) entries = new AbstractObjectSortedSet<Int2IntMap.Entry >() {
            final Comparator<? super Int2IntMap.Entry > comparator = new Comparator<Int2IntMap.Entry > () {
                public int compare( final Int2IntMap.Entry x, Int2IntMap.Entry y ) {
                    return Int2IntRBTreeCounter.this.storedComparator.compare( x.getKey(), y.getKey() );
                }
            };
            ...
            public ObjectBidirectionalIterator<Int2IntMap.Entry > iterator( final Int2IntMap.Entry from ) {
            ...
            public boolean remove( final Object o ) {
                ...
                final Map.Entry<Integer, Integer> e = (Map.Entry<Integer, Integer>)o;
                final Entry f = findKey( ((e.getKey()).intValue()) );
                if ( f != null ) Int2IntRBTreeCounter.this.remove( f.key );
                return f != null;
            }
            public int size() { return count; }
            public void clear() { Int2IntRBTreeCounter.this.clear(); }
            public Int2IntMap.Entry first() { return firstEntry; }
            public Int2IntMap.Entry last() { return lastEntry; }
            public ObjectSortedSet<Int2IntMap.Entry > subSet( Int2IntMap.Entry from, Int2IntMap.Entry to ) { return subMap( from.getKey(), to.getKey() ).int2IntEntrySet(); }
            public ObjectSortedSet<Int2IntMap.Entry > headSet( Int2IntMap.Entry to ) { return headMap( to.getKey() ).int2IntEntrySet(); }
            public ObjectSortedSet<Int2IntMap.Entry > tailSet( Int2IntMap.Entry from ) { return tailMap( from.getKey() ).int2IntEntrySet(); }
        };
        return entries;
    }
    ...
    private final class ValueIterator extends TreeIterator implements IntListIterator {
        public int nextInt() { return nextEntry().value; }
        public int previousInt() { return previousEntry().value; }
        ...
        public Integer next() { return (Integer.valueOf(nextEntry().value)); }
        public Integer previous() { return (Integer.valueOf(previousEntry().value)); }
        public void set( Integer ok ) { throw new UnsupportedOperationException(); }
        public void add( Integer ok ) { throw new UnsupportedOperationException(); }
    };
    ...
    public IntCollection values() {
        if ( values == null ) values = new AbstractIntCollection () {
            ...
            public void clear() {
                Int2IntRBTreeCounter.this.clear();
            }
        };
        return values;
    }
     ...
     * on-the-fly.
     */
    private final class Submap extends AbstractInt2IntSortedMap implements java.io.Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        ...
        public Submap( final int from, final boolean bottom, final int to, final boolean top ) {
            if ( ! bottom && ! top && Int2IntRBTreeCounter.this.compare( from, to ) > 0 ) throw new IllegalArgumentException( "Start key (" + from + ") is larger than end key (" + to + ")" );
            this.from = from;
            this.bottom = bottom;
            this.to = to;
            this.top = top;
            this.defRetValue = Int2IntRBTreeCounter.this.defRetValue;
        }
        public void clear() {
        ...
        final boolean in( final int k ) {
            return ( bottom || Int2IntRBTreeCounter.this.compare( k, from ) >= 0 ) &&
                    ( top || Int2IntRBTreeCounter.this.compare( k, to ) < 0 );
        }
        public ObjectSortedSet<Int2IntMap.Entry > int2IntEntrySet() {
            if ( entries == null ) entries = new AbstractObjectSortedSet<Int2IntMap.Entry >() {
                public ObjectBidirectionalIterator<Int2IntMap.Entry > iterator() {
                ...
                public Comparator<? super Int2IntMap.Entry > comparator() { return Int2IntRBTreeCounter.this.int2IntEntrySet().comparator(); }
                @SuppressWarnings("unchecked")
                public boolean contains( final Object o ) {
                    if (!(o instanceof Map.Entry)) return false;
                    final Map.Entry<Integer, Integer> e = (Map.Entry<Integer, Integer>)o;
                    final Int2IntRBTreeCounter.Entry f = findKey( ((e.getKey()).intValue()) );
        ...
        @SuppressWarnings("unchecked")
        public boolean containsKey( final int k ) {
            return in( k ) && Int2IntRBTreeCounter.this.containsKey( k );
        }
        public boolean containsValue( final int v ) {
            final SubmapIterator i = new SubmapIterator();
            int ev;
        ...
        @SuppressWarnings("unchecked")
        public int get(final int k) {
            final Int2IntRBTreeCounter.Entry e;
            final int kk = k;
        ...
        public int put(final int k, final int v) {
            ...
            final int oldValue = Int2IntRBTreeCounter.this.put( k, v );
        ...
        public int remove( final int k ) {
            ...
            final int oldValue = Int2IntRBTreeCounter.this.remove( k );
         ...
         */
        public Int2IntRBTreeCounter.Entry lastEntry() {
            if ( tree == null ) return null;
        ...
        public int firstIntKey() {
            Int2IntRBTreeCounter.Entry e = firstEntry();
            if ( e == null ) throw new NoSuchElementException();
            return e.key;
        }
        public int lastIntKey() {
            Int2IntRBTreeCounter.Entry e = lastEntry();
            if ( e == null ) throw new NoSuchElementException();
            return e.key;
        }
        ...
        private class SubmapIterator extends TreeIterator {
            ...
            void updatePrevious() {
                prev = prev.prev();
                if ( ! bottom && prev != null && Int2IntRBTreeCounter.this.compare( prev.key, from ) < 0 ) prev = null;
            }
            void updateNext() {
                next = next.next();
                if ( ! top && next != null && Int2IntRBTreeCounter.this.compare( next.key, to ) >= 0 ) next = null;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public Int2IntRBTreeCounter clone() {
        Int2IntRBTreeCounter c;
        try {
            c = (Int2IntRBTreeCounter )super.clone();
        }
        catch(CloneNotSupportedException cantHappen) {
            throw new InternalError();
        }
    ...
    private Entry readTree( final java.io.ObjectInputStream s, final int n, final Entry pred, final Entry succ ) throws java.io.IOException, ClassNotFoundException {
        if ( n == 1 ) {
            final Entry top = new Entry ( s.readInt(), s.readInt() );
            top.pred( pred );
            top.succ( succ );
            top.black( true );
            return top;
