 ...
 *
 */
public class Int2FloatRBTreeCounter extends AbstractInt2FloatSortedMap implements java.io.Serializable, Cloneable {
    ...
    protected transient volatile ObjectSortedSet<Int2FloatMap.Entry > entries;
    /** Cached set of keys. */
  ...
  /* If the provided comparator is already type-specific, we use it. Otherwise,
     ...
     */
    public Int2FloatRBTreeCounter( final Comparator<? super Integer> c ) {
        this();
        storedComparator = c;
        setActualComparator();
    }
     ...
     */
    public Int2FloatRBTreeCounter( final Map<? extends Integer, ? extends Float> m ) {
        this();
        putAll( m );
    }
     ...
     */
    public Int2FloatRBTreeCounter( final SortedMap<Integer,Float> m ) {
        this( m.comparator() );
        putAll( m );
    }
    /** Creates a new tree map copying a given map.
     ...
     */
    public Int2FloatRBTreeCounter( final Int2FloatMap m ) {
        this();
        putAll( m );
    }
    /** Creates a new tree map copying a given sorted map (and its {@link Comparator}).
     ...
     */
    public Int2FloatRBTreeCounter( final Int2FloatSortedMap m ) {
        this( m.comparator() );
        putAll( m );
    }
     ...
     */
    public Int2FloatRBTreeCounter( final int[] k, final float v[], final Comparator<? super Integer> c ) {
        this( c );
     ...
     * @throws IllegalArgumentException if <code>k</code> and <code>v</code> have different lengths.
     */
    public Int2FloatRBTreeCounter( final int[] k, final float v[] ) {
        this( k, v, null );
    }
 /*
    ...
    public float increment( final int k, final float v ) {
        modified = false;
        int maxDepth = 0;
        if ( tree == null ) { // The case of the empty tree is treated separately.
            count++;
    ...
    public Float put( final Integer ok, final Float ov ) {
        final float oldValue = put( ((ok).intValue()), ((ov).floatValue()) );
        return modified ? (null) : (Float.valueOf(oldValue));
    }
    public Float remove( final Object ok ) {
        final float oldValue = remove( ((((Integer)(ok)).intValue())) );
        return modified ? (Float.valueOf(oldValue)) : (null);
    }
     ...
     */
    private static final class Entry implements Cloneable, Int2FloatMap.Entry {
        ...
        public boolean equals( final Object o ) {
            ...
            return ( (key) == (((e.getKey()).intValue())) ) && ( (value) == (((e.getValue()).floatValue())) );
        }
        public int hashCode() {
  ...
  /*
   ...
   /* If the last operation was a next(), we are removing an entry that preceeds
            ...
            updatePrevious();
            updateNext();
            Int2FloatRBTreeCounter.this.remove( curr.key );
            curr = null;
        }
    ...
    private class EntryIterator extends TreeIterator implements ObjectListIterator<Int2FloatMap.Entry > {
        ...
        public Int2FloatMap.Entry next() { return nextEntry(); }
        public Int2FloatMap.Entry previous() { return previousEntry(); }
        public void set( Int2FloatMap.Entry ok ) { throw new UnsupportedOperationException(); }
        public void add( Int2FloatMap.Entry ok ) { throw new UnsupportedOperationException(); }
    }
    public ObjectSortedSet<Int2FloatMap.Entry > int2FloatEntrySet() {
        if ( entries == null ) entries = new AbstractObjectSortedSet<Int2FloatMap.Entry >() {
            final Comparator<? super Int2FloatMap.Entry > comparator = new Comparator<Int2FloatMap.Entry > () {
                public int compare( final Int2FloatMap.Entry x, Int2FloatMap.Entry y ) {
                    return Int2FloatRBTreeCounter.this.storedComparator.compare( x.getKey(), y.getKey() );
                }
            };
            ...
            public boolean remove( final Object o ) {
                ...
                final Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
                final Entry f = findKey( ((e.getKey()).intValue()) );
                if ( f != null ) Int2FloatRBTreeCounter.this.remove( f.key );
                return f != null;
            }
            public int size() { return count; }
            public void clear() { Int2FloatRBTreeCounter.this.clear(); }
            public Int2FloatMap.Entry first() { return firstEntry; }
            public Int2FloatMap.Entry last() { return lastEntry; }
            public ObjectSortedSet<Int2FloatMap.Entry > subSet( Int2FloatMap.Entry from, Int2FloatMap.Entry to ) { return subMap( from.getKey(), to.getKey() ).int2FloatEntrySet(); }
            public ObjectSortedSet<Int2FloatMap.Entry > headSet( Int2FloatMap.Entry to ) { return headMap( to.getKey() ).int2FloatEntrySet(); }
            public ObjectSortedSet<Int2FloatMap.Entry > tailSet( Int2FloatMap.Entry from ) { return tailMap( from.getKey() ).int2FloatEntrySet(); }
        };
        return entries;
    }
    ...
    private final class ValueIterator extends TreeIterator implements FloatListIterator {
        public float nextFloat() { return nextEntry().value; }
        public float previousFloat() { return previousEntry().value; }
        public void set( float v ) { throw new UnsupportedOperationException(); }
        public void add( float v ) { throw new UnsupportedOperationException(); }
        public Float next() { return (Float.valueOf(nextEntry().value)); }
        public Float previous() { return (Float.valueOf(previousEntry().value)); }
    ...
    public FloatCollection values() {
        if ( values == null ) values = new AbstractFloatCollection () {
            ...
            public void clear() {
                Int2FloatRBTreeCounter.this.clear();
            }
        };
        return values;
    }
    ...
    private final class Submap extends AbstractInt2FloatSortedMap implements java.io.Serializable {
        ...
        public Submap( final int from, final boolean bottom, final int to, final boolean top ) {
            if ( ! bottom && ! top && Int2FloatRBTreeCounter.this.compare( from, to ) > 0 ) throw new IllegalArgumentException( "Start key (" + from + ") is larger than end key (" + to + ")" );
            this.from = from;
            this.bottom = bottom;
            this.to = to;
            this.top = top;
            this.defRetValue = Int2FloatRBTreeCounter.this.defRetValue;
        }
        public void clear() {
        ...
        final boolean in( final int k ) {
            return ( bottom || Int2FloatRBTreeCounter.this.compare( k, from ) >= 0 ) &&
                    ( top || Int2FloatRBTreeCounter.this.compare( k, to ) < 0 );
        }
        public ObjectSortedSet<Int2FloatMap.Entry > int2FloatEntrySet() {
            if ( entries == null ) entries = new AbstractObjectSortedSet<Int2FloatMap.Entry >() {
                public ObjectBidirectionalIterator<Int2FloatMap.Entry > iterator() {
                ...
                public Comparator<? super Int2FloatMap.Entry > comparator() { return Int2FloatRBTreeCounter.this.int2FloatEntrySet().comparator(); }
                @SuppressWarnings("unchecked")
                public boolean contains( final Object o ) {
                    if (!(o instanceof Map.Entry)) return false;
                    final Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
                    final Int2FloatRBTreeCounter.Entry f = findKey( ((e.getKey()).intValue()) );
        ...
        @SuppressWarnings("unchecked")
        public boolean containsKey( final int k ) {
            return in( k ) && Int2FloatRBTreeCounter.this.containsKey( k );
        }
        public boolean containsValue( final float v ) {
            final SubmapIterator i = new SubmapIterator();
            float ev;
        ...
        @SuppressWarnings("unchecked")
        public float get(final int k) {
            final Int2FloatRBTreeCounter.Entry e;
            final int kk = k;
        ...
        public float put(final int k, final float v) {
            ...
            final float oldValue = Int2FloatRBTreeCounter.this.put( k, v );
        ...
        public float remove( final int k ) {
            ...
            final float oldValue = Int2FloatRBTreeCounter.this.remove( k );
         ...
         */
        public Int2FloatRBTreeCounter.Entry lastEntry() {
            if ( tree == null ) return null;
        ...
        public int firstIntKey() {
            Int2FloatRBTreeCounter.Entry e = firstEntry();
            if ( e == null ) throw new NoSuchElementException();
            return e.key;
        }
        public int lastIntKey() {
            Int2FloatRBTreeCounter.Entry e = lastEntry();
            if ( e == null ) throw new NoSuchElementException();
            return e.key;
        }
        ...
        private class SubmapIterator extends TreeIterator {
            ...
            void updatePrevious() {
                prev = prev.prev();
                if ( ! bottom && prev != null && Int2FloatRBTreeCounter.this.compare( prev.key, from ) < 0 ) prev = null;
            }
            void updateNext() {
                next = next.next();
                if ( ! top && next != null && Int2FloatRBTreeCounter.this.compare( next.key, to ) >= 0 ) next = null;
            }
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public Int2FloatRBTreeCounter clone() {
        Int2FloatRBTreeCounter c;
        try {
            c = (Int2FloatRBTreeCounter )super.clone();
        }
        catch(CloneNotSupportedException cantHappen) {
            throw new InternalError();
        }
